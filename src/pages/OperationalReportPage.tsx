        ...
        <div className="relative mx-auto max-w-5xl px-5 py-12 sm:px-6 sm:py-24 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-teal-600 px-5 py-2.5 text-sm font-bold text-white shadow-md transition hover:bg-teal-500 active:scale-95"
            >
              <Maximize2 size={16} />
