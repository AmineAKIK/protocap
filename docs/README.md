...
- [`remediation-plan.md`](remediation-plan.md) — ordered correction contract, F01–F24 traceability and T01–T45 acceptance catalogue.
- [`remediation-baseline.md`](remediation-baseline.md) — PR-01 Node 24 baseline, date/storage inventory and hermetic E2E evidence.
